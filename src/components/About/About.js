    ...
    return (
        <div name='about'>
            <section className='about container'>
                ...
                {currentLanguage === LANGUAGES[0] ? <div className='about__text'>Живу в городе Санкт-Петербург. 27 лет. Заканчиваю программу переквалификации на GeekBrains в июне. Имею опыт написания проектов на JavaScript, Vue и React.
                    ...
                    <div className='about__text'>I live in Saint Petersburg. 27y.o. Finishing the GeekBrains retraining program in June. I have experience writing projects in JavaScript, Vue and React.
