      ...
      <section className="about container">
        ...
        {currentLanguage === LANGUAGES[0] ? (
          <div className="about__text">
            Живу в городе Санкт-Петербург. 27 лет. Закончила программу
            ...
            Готова много учиться и умею делать это быстро.{' '}
          </div>
        ) : (
          <div className="about__text">
            I live in Saint Petersburg. 27y.o. Finished the GeekBrains
            retraining program in June. I have experience writing projects in
            ...
            in <span className="txt-yellow">mnemonics</span>. Ready to learn a
            lot and know how to do it quickly.
          </div>
        )}
        <div
