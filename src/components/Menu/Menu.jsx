...
export function Menu() {
  ...
  return (
    <nav className="menu__wrap">
      <ul className="menu">
        <Link
          activeClass="menu__item__active"
          ...
          offset={0}
          duration={1000}
          onSetActive={() => handleSetActive(SECTION_LINKS.home)}
          onSetInactive={() => handleSetInactive(SECTION_LINKS.home)}
        ></Link>
        {menuList.map((item) => {
          return (
            <Link
              ...
              isDynamic={true}
              duration={1000}
              onSetActive={() => handleSetActive(item.link)}
              onSetInactive={() => handleSetInactive(item.link)}
            >
      ...
      <Link
        className={`menu__up animate__animated ${
          activeSection === ''
            ? ''
            : activeSection !== SECTION_LINKS.home &&
              activeSection !== SECTION_LINKS.education
            ? 'animate__fadeInUp flex'
            : 'animate__fadeOutDown flex'
        }`}
        to="app"
        spy={true}
        hashSpy={false}
